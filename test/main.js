...
describe('gulp-conkitty', function() {
    describe('conkitty()', function() {
        ...
        testConkitty(
            {
                common: {file: 'tmp/ok.common', 'concat.js': false},
                templates: 'tmp/ok',
                sourcemap: 'tmp/ok.map',
                deps: true
            },
        ...
        testConkitty(
            {
                templates: 'tmp/libtest',
                deps: true,
                libs: {
                    'somelib': require('./sub/lib/index.js')
                }
            },
            [
                'libtest.ctpl'
            ...
            [
                'tmp/libtest', '// This file is autogenerated.',
                'somelib/lib.css', 'button { background: red; }',
                'file5.css', '.class5 {}'
            ],
            true // Not cwd test.
        );
