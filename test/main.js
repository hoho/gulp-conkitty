    ...
    describe('conkitty()', function() {
        ...
        testConkitty(
            {
                ...
                deps: {'..': 'ololo/'} // Rebase outside files to ololo dir.
            },
            [
                'tpl4.ctpl',
                '../tpl1.ctpl',
            ...
            [
                ...
                'ololo/file3.css', '.clsss3 {}',
                'ololo/file2.js', 'function func2() {}',
                'ololo/file1.css', '.class1 {}',
                'ololo/file2.css', '.class2 {}',
                'ololo/file1.js', 'function func1() {}',
                'file4.css', '.class4 {}'
            ],
            true // Not cwd test.
        );
        ...
        function testConkitty(settings, files, results, notcwd) {
            it('should compile templates', function(done) {
                ...
                if (notcwd) {
                    process.chdir(path.join(oldcwd, 'test', 'sub'));
                }
